...
public class AsyncHttpClient extends AsyncTask<String, Void, String> {
        ...
        try {
            ...
            HttpsURLConnection.setDefaultHostnameVerifier(new HostnameVerifier() {
                ...
                public boolean verify(String hostname, SSLSession session) {
                    ...
                    if (hostname.equalsIgnoreCase("mtel.at")
                            || hostname.equalsIgnoreCase("prelive.mtel.at")
                            || hostname.equalsIgnoreCase("mtel.at/chat2")
                            || hostname.equalsIgnoreCase("skyfire.vimeocdn.com")
                            || hostname.equalsIgnoreCase("player.vimeo.com")
                        ...
                        Log.e("DTag", "AsyncHttpClient: setDefaultHostnameVerifier: BLOCKING hostname -> " + hostname);
                        return false;
                    }
            ...
            Log.e("DTag", "AsyncHttpClient: trustAllCertificates: exception: " + e.toString());
        }
    }
    ...
    private void trustAllCertificates() {
        try {
            ...
            context.init(null, new X509TrustManager[]{new X509TrustManager() {
                ...
                public void checkServerTrusted(X509Certificate[] chain, String authType) throws CertificateException {
                    try {
                        ...
                        Log.e("DTag", "trustAllCertificates -> checkServerTrusted -> exception: " + e.toString());
                    }
                }
                public X509Certificate[] getAcceptedIssuers() {
            ...
            Log.e("DTag", "trustAllCertificates: exception: " + e.toString());
        }
    }*/
